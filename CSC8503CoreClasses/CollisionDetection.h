	...
	public:
		...
		struct CollisionInfo {
			...
			void AddContactPoint(const Vector3& localA, const Vector3& localB, const Vector3& normal, float p) {
				...
				newPoint.localA = localA;
				newPoint.localB = localB;
				newPoint.normal = normal;
				newPoint.penetration = p;
		...
		static float SAT(const Vector3& relativePos, const Vector3 axes[15], const int axis, const Transform& worldTransformA,
